...
{#if menu}
<div in:slide={{duration:600}} out:slide class="{ menu? 'visible':'invisible' } mobile-menu w-full top-0 left-0 right-0 bg-black/95 backdrop-filter backdrop-blur-lg fixed z-50  h-full md:hidden">
  <div class="left-0 right-0 top-0 font-lato px-0 flex justify-end">
    <button class="lg:hidden rounded-md bg-transparent text-black border-transparent px-3" on:click={close_menu}>
  ...
  <div class="mt-0 px-16 pb-16 pt-4 font-merri">
    <div class="list-none py-2 grid grid-cols-1 grid-rows-5 gap-y-7">
      <div on:click={close_menu} in:fade={{delay:200}} class="text-2xl">
        <a href="/" class="flex">
      ...
      <div on:click={close_menu} in:fade={{delay:270}} class="text-2xl">
      ...
      <div on:click={close_menu} in:fade={{delay:380}} class="text-2xl">
      ...
      <div on:click={close_menu} in:fade={{delay:500}} class="text-2xl">
